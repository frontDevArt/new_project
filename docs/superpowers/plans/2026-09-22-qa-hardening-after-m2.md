...
- [ ] **Шаг 3: мерить от начала цепочки, а не от соседа**
...
- [ ] **Шаг 1: падающие тесты на устойчивость**
...
- [ ] **Шаг 3: якорь вместо границ площади**
...
- [ ] **Шаг 3: считать кластеры всегда, а не по признаку пустой колонки**
...
- [ ] Дописать раздел «Результат фазы 2»: числа батареи, сколько кластеров
...
- [ ] **Шаг 4: правленая заявка идёт по всей базе**
