...
- [ ] **Шаг 3: написать `listam/domain/clustering.py`**
...
- [ ] **Шаг 4: написать `listam/clustering_run.py` и команду**
...
- [ ] «Результат фазы 3» с числами батареи и — обязательно — прогон
...
- [ ] Стартовый промпт для фазы 4. Коммит.
