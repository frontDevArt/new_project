...
- [ ] **Шаг 3. Реализовать `listam/changes.py`.**
...
- [ ] **Шаг 4. Подключить команду в `listam/cli.py`.**
...
- [ ] **Шаг 5. Дописать строку в таблицу команд README.**

- [ ] **Шаг 6. Прогнать всю батарею.** Ожидается 357 passed, 12 skipped.
